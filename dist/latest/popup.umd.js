...
(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Popup = factory());
	...
	class Popup {
		...
		middleBox(param) {
			...
			const { title = '默认标题内容',
				content = '弹窗的默认提示信息！', titleBtn = true, closeBtn = true, closeBtnStyle = {}, btnStyle = {}, contentStyle = {}, titleStyle = {},closePreview=()=>{} } = param;
		...
		<path d="M6 6L18 18M18 6L6 18" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
				...
				closeBtn && this.contentBox.appendChild(this.closeBtn);
		...
		showImagePreview({ imgUrl, color, onClose, svgIcon }) {
			...
			this.middleBox({ content: '', titleBtn: false });
		...
		load = (paramObj = {}) => {
			...
			*/
			...
			this.queue.push(() => {
				...
				const size = styleObj.width - styleObj.height > 0 ? styleObj.width : styleObj.height;
